    ...
    <Tilt className="xs:w-[250px] w-full">
      <div ref={cardRef} className="w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card">
        <div className="bg-tertiary rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col">
          ...
          <h3 className="text-amber-500 text-[20px] font-bold text-center">{title}</h3>
        </div>
      </div>
    </Tilt>
  );
  ...
  return (
    <>
      <div ref={headingRef}>
        ...
        <h2 className='text-amber-500 font-bold text-6xl'>Overview.</h2>
      </div>

      <p ref={paragraphRef} className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
        I'm a skilled software developer with experience in  JavaScript, and expertise in frameworks 
        like <span className="text-amber-500">React, Node.js, and Three.js</span> . I'm a quick learner and collaborate closely with clients to create efficient, 
