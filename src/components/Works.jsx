  ...
  return (
    <div ref={cardRef}>
      ...
      >
        ...
        <div className="mt-5">
          <h3 className="text-amber-500 font-bold text-[24px]">{name}</h3>
...
const Works = () => {
  ...
  return (
    <>
      ...
      <div className="works-container mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center gap-6">
